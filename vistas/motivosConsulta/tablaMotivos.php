...
$sql = "SELECT * FROM motivos_consulta";
$respuesta = mysqli_query($conexion, $sql);

?>

<table class="table table-sm table-hover table-responsive dt-responsive nowrap table-striped" style="width:100%" id="tablaMotivosDataTable">
    <thead>
        <th>ID</th>
        <th>Motivo</th>
        <th>Acciones</th>
    ...
    <tbody>
        ...
        ?>
        <tr>
            <td><?php echo $mostrar['id_motivo'];?></td>
...
<script>
    $(document).ready(function(){
        $('#tablaMotivosDataTable').DataTable({
            "language": {
