<?php
    ...
    $sql="SELECT 
            ...
            usuarios.id_rol AS rolPsicologo, 
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <select class="form-control form-select" name="pacienteu" id="pacienteu">
                        ...
                        <div class="col-sm-5">
                            ...
                            <select class="form-control form-select" name="tipo_sesionu" id="tipo_sesionu" required>
